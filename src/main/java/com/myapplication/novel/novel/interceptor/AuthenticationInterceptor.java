package com.myapplication.novel.novel.interceptor;
...
import com.myapplication.novel.novel.annotation.PassToken;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (method.isAnnotationPresent(UserLoginToken.class)) {
            ...
            if (userLoginToken.required()) {
                ...
                User user = userRespository.findByAccount(userId);
                if (user == null) {
...
//                    Tokenfiled(response);
                    throw new RuntimeException(new BaseResult(HttpCode.tokenfiled, HttpCode.tokenfiledmsg, null).toString());
                }
                return true;
            }
        }
